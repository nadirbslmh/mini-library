...
# # get book by id
# curl -XGET 'http://localhost:8080/api/v1/books/5'

# get all rents
# curl -XGET 'http://localhost:8080/api/v1/rents'

# create rent
curl -XPOST -H "Content-type: application/json" -d '{"user_id":1,"book_id":3,"book_title":"belum dinamis"}' 'http://localhost:8080/api/v1/rents'